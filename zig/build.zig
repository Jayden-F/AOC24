...
pub fn build(b: *std.Build) void {
    ...
    const new_lib = b.addStaticLibrary(.{
        .name = "zig",
        // In this case the main source file is merely a path, however, in more
        // complicated build scripts, this could be a generated file.
        .root_source_file = b.path("src/pqueue.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const pqueue_unit_tests = b.addTest(.{
        .root_source_file = b.path("src/pqueue.zig"),
        .target = target,
        .optimize = optimize,
    });
    const run_pqueue_unit_tests = b.addRunArtifact(pqueue_unit_tests);
    ...
    const day7_unit_tests = b.addTest(.{
        .root_source_file = b.path("src/day_7.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    test_step.dependOn(&run_pqueue_unit_tests.step);
